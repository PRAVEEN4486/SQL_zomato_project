...
/*2. how many days has each customer visited zomzto?*/
select userid,count(distinct created_date) as distinct_day from sales group by userid;

/*3. what was first product purchased by each customers*/
select * from
(select *,rank() over(partition by userid order by created_date) rnk from sales) a where rnk =1;

/*what is the most purchased item on menu and how many times it was purchased?*/
...
/*which was first item purchased by customer when they became a member*/
select * from goldusers_signup;
